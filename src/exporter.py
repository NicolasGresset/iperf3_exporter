...
def run_test(reverse : bool, address : str, port : int, duration :  int, protocol : str) -> tuple:
    ...
    return result.json["end"]["sum_received"]["bytes"], result.json["end"]["sum_sent"]["bytes"], result.json["end"]["sum_received"]["seconds"]
...
def run_tests():
    ...
    r_down_received_bytes, r_down_sent_bytes, r_down_duration = run_test(False, target_ip, target_port, test_duration, test_protocol)
    r_up_received_bytes, r_up_sent_bytes, r_up_duration = run_test(True, target_ip, target_port, test_duration, test_protocol)
